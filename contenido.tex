...
A modo ilustrativo, se presenta como ejemplo del sistema desarrollado un conjunto de pruebas que verifica el comportamiento del endpoint POST /calificaciones-generales, cuyas operaciones aparecen en el apartado~\ref{subsec:logic}, comprobando tanto el caso exitoso de creación o actualización de una calificación general como la correcta gestión de errores. Se valida que una calificación válida sea procesada correctamente y devuelta con estado 200, que la nota se encuentre dentro del rango permitido y que las reglas de negocio asociadas a las calificaciones extraordinarias se cumplan.
...
\begin{itemize}
    \item \textbf{Pruebas unitarias:} Se prueban de forma aislada funciones, métodos y componentes Angular para asegurar que cumplen con su funcionalidad esperada.
    \item \textbf{Pruebas de componentes:} Se comprueba la correcta renderización, interacción y comunicación con servicios de los componentes, simulando eventos y validando resultados.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Karma:} Ejecuta los tests en navegadores reales o headless, facilitando la integración con Angular.
    \item \textbf{Jasmine:} Framework de aserciones y spies para estructurar y definir las pruebas unitarias y de componentes.
\end{itemize}
...
A continuación se muestra un ejemplo simplificado del sistema desarrollado de test para el componente Angular "Tab5Page" mostrado previamente, donde se comprueba que se crea correctamente y que muestra un mensaje esperado:
