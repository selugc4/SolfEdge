...
Una vez expuesto el diagrama de casos de uso, el sistema queda descrito de manera demasiado abstracta aún puesto que la visión tan genérica que da el diagrama no permite entender los detalles de cada funcionalidad. Por ello, como es habitual en los proyectos informáticos, se definirán los requisitos funcionales del sistema relacionándolos con cada uno de los casos de uso.
\begin{table}[H]
\begin{center}
\begin{tabular}{| m{3cm} | m{2cm} | m{2cm} | m{2cm} | m{2cm} |}
\hline
\textbf{Nombre} & \multicolumn{4}{c|} {\textbf{Crear profesor}} \\ \hline
\textbf{Descripción} & \multicolumn{4}{m{14cm}|}{Permitir al profesor administrador crear nuevos usuarios con rol de profesor en el sistema, proporcionando los datos necesarios y validando la información.} \\ \hline
\textbf{Requisitos funcionales} & RF-01 & RF-02 & RF-03 & RF-04 \\ \hline
\end{tabular}
