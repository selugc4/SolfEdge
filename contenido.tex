...
\textbf{Descripción} & Permitir al profesor administrador crear nuevos usuarios con rol de profesor en el sistema, proporcionando los datos necesarios y validando la información. \\ \hline
...
\textbf{RF-01} & Iniciar sesión \\ \hline
...
\begin{itemize}
  ...
  \item El sistema no puede conectarse a la base de datos para validar credenciales.
\end{itemize} \\ \hline
\end{tabularx}
...
\textbf{RF-02} & Recuperar contraseña \\ \hline

\textbf{Descripción} & Permitir al usuario recuperar el acceso a su cuenta mediante la verificación de su identidad y la creación de una nueva contraseña. \\ \hline
...
\begin{enumerate}
  ...
  \item El sistema envía la contraseña por correo.
\end{enumerate} \\ \hline
...
\begin{itemize}
  ...
  \item El usuario no recibe el correo de recuperación.
  \item El enlace o código de recuperación ha expirado o es inválido.
