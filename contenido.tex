...
Un buen ejemplo de usabilidad se aprecia en la gestión de calificaciones donde, a través de un \texttt{IonModal} (ver Figura~\ref{fig:componentes_ion}), el usuario puede editar datos sin salir de la vista principal, manteniendo el contexto y agilizando la interacción. Otro buen ejemplo es el uso de distintos menús según el contexto (Figura~\ref{fig:navegacion_componentes}).
...
\begin{itemize}
    ...
    \item \textbf{Contraste y legibilidad:} La paleta de colores se ha escogido para ofrecer un contraste adecuado entre texto, fondos y elementos interactivos, facilitando la lectura incluso en condiciones de baja iluminación o para personas con deficiencias visuales (Figura~\ref{fig:accesibilidad}).
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.6\textwidth]{Figuras/frontend_login_desktop.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{Figuras/frontend_menu_lateral.png}
    \includegraphics[width=0.6\textwidth]{Figuras/frontend_barra_pestañas.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Figuras/frontend_calificaciones_ioncard.png}
...
\begin{itemize}
    ...
    \item \textbf{Gestión masiva de usuarios mediante archivos:} Incorporación de funcionalidades que permitan dar de alta usuarios a partir de archivos con un formato definido (por ejemplo CSV), evitando la creación manual y agilizando la administración por parte del profesorado o los centros.
\end{itemize}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{Vista de profesor de rama con libro y tareas}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Figuras/frontend_mensajes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Figuras/frontend_formulario.png}
