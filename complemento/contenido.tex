...
\nuevo{Del mismo modo, el administrador podrá revisar la lista de profesores creados y eliminarlos. La eliminación de un profesor implicará la eliminación coherente de toda la información asociada creada bajo su responsabilidad (material, tareas, cuestionarios, grupos y alumnado asociado a dichos grupos).}
...
\textbf{Secuencia de pasos} &
\begin{enumerate}
  \item El administrador accede al área de administración y entra en la sección de profesores.
...
\textbf{Descripción} & Permitir al administrador eliminar un profesor del sistema, eliminando de forma coherente todo su material asociado, sus grupos y los alumnos creados bajo su responsabilidad, evitando referencias huérfanas o inconsistencias. \\ \hline
...
\begin{enumerate}
  ...
  \item El sistema muestra confirmación e informa del alcance (material, grupos y alumnado afectado).
...
\begin{figure}[H]
    ...
    \caption{Entorno de desarrollo y construcción móvil utilizado para la exportación a Android (logo pendiente de incluir).}
